...
.. glossary::
   ...
   Agent (deployment method)
      Agent is a deployment method where an instance of :term:`Splunk Distribution of OpenTelemetry Collector` runs with the application or on the same host as the application. For example,
      when you configure :term:`Splunk OpenTelemetry Collector` for Linux, Kubernetes, or Windows, you are using the agent deployment method.
   ...
   Gateway (deployment method)
      Gateway is a deployment method where :term:`Splunk Distribution of OpenTelemetry Collector` is running by itself. When you configure Splunk Distribution of OpenTelemetry Collector as a standalone package, you are using the gateway deployment method.
   ...
   Splunk Distribution of OpenTelemetry Collector
      A Splunk Observability Cloud version of the open-source OpenTelemetry Collector, this service provides a unified way to receive, process, and export traces, metrics, and logs data for Splunk Observability Cloud.
      Configuring Splunk Distribution of OpenTelemetry Collector uses the :term:`gateway deployment method <Gateway (deployment method)>`.

   Splunk OpenTelemetry Collector
      Splunk OpenTelemetry Collector is a package that bundles Splunk Distribution of OpenTelemetry Collector with additional components to provide integrated collection and forwarding of traces, metrics, and logs for a specific platform. Configuring Splunk OpenTelemetry Collector uses the :term:`agent deployment method <Agent (deployment method)>`.
